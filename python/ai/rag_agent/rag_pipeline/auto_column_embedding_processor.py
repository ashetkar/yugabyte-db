...
BATCH_MAX = int(os.getenv("AUTO_COLUMN_EMBEDDING_BATCH_MAX", "500"))
BATCH_MAX_WAIT_SECONDS = int(os.getenv("AUTO_COLUMN_EMBEDDING_BATCH_MAX_WAIT_SECONDS", "60"))
MAX_ATTEMPTS = int(os.getenv("AUTO_COLUMN_EMBEDDING_MAX_ATTEMPTS", "5"))
RETRY_BACKOFF_BASE_SECONDS = float(
    os.getenv("AUTO_COLUMN_EMBEDDING_RETRY_BACKOFF_BASE_SECONDS", "2")
)
PER_TENANT_FLUSH_CAP = int(os.getenv("AUTO_COLUMN_EMBEDDING_PER_TENANT_FLUSH_CAP", "100"))
...
FALLBACK_EMBEDDING_MODEL = os.getenv(
    "AUTO_COLUMN_EMBEDDING_FALLBACK_MODEL", "text-embedding-3-large"
)
