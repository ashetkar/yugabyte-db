...
| ------- | ------------------------ | ------------------------ | ---------------------|
| Yugabyte Psycopg 2 Smart Driver [Recommended] | [Documentation](yugabyte-psycopg2/) <br /> [Reference](yugabyte-psycopg2-reference/)| [latest version](https://github.com/yugabyte/psycopg2) | 2.8 and above |
| Yugabyte Psycopg 3 Smart Driver | [Documentation](yugabyte-psycopg3/) <br /> [Reference](yugabyte-psycopg3-reference/) | [latest version](https://pypi.org/project/psycopg-yugabytedb/) | 2.20 and above |
| PostgreSQL Psycopg 2 Driver | [Documentation](postgres-psycopg2/) <br /> [Reference](postgres-psycopg2-reference/) | [latest version](https://github.com/psycopg/psycopg2) | 2.8 and above |
| PostgreSQL Psycopg 3 Driver | [Documentation](postgres-psycopg3/) <br /> [Reference](postgres-psycopg3-reference/) | [latest version](https://github.com/psycopg/psycopg) | 2.20 and above |
| aiopg | [Documentation](aiopg/) | [latest version](https://pypi.org/project/aiopg/) | 2.8 and above |
| YugabyteDB Python Driver for YCQL | [Documentation](ycql/) | [latest version](https://github.com/yugabyte/cassandra-python-driver/tree/master) | |
